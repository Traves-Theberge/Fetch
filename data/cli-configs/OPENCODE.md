# OPENCODE.md — Fetch Kennel Instructions
...
4. **No interactive prompts.** You are running in non-interactive mode. Do not ask questions — if something is ambiguous, make the safest reasonable choice and note it in your output.
